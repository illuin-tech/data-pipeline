 ...
 */
public class PipelineSinkMetrics extends MDCMarker
{
    ...
    public PipelineSinkMetrics(MeterRegistry meterRegistry, ComponentTag tag, MetricTags metricTags, MDCManager mdc)
    {
        super(mdc);
        this.tag = tag;
