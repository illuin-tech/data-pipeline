 ...
 */
public class IllegalInitializerIllegalArgumentPayload<T>
{
    private static final Logger logger = LoggerFactory.getLogger(IllegalInitializerIllegalArgumentPayload.class);

    @InitializerConfig
    public TestPayload execute(@Payload T data, UIDGenerator generator)
    {
        logger.info("payload: {}", data);
        return new TestPayload(new TestObject(generator.generate(), "illegal_payload"));
    }
}
