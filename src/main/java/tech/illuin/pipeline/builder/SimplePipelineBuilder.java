...
public final class SimplePipelineBuilder<I> extends PipelineBuilder<I, VoidPayload>
{
    ...
    @Override
    public <T extends Indexable> SimplePipelineBuilder<I> registerSteps(List<? extends Step<? extends T, I, VoidPayload>> steps)
    {
    ...
    @Override
    public <T extends Indexable> SimplePipelineBuilder<I> registerStepAssemblers(List<? extends StepAssembler<? extends T, I, VoidPayload>> builders)
    {
