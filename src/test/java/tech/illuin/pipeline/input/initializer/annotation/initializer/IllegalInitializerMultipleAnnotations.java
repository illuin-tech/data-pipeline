 ...
 */
public class IllegalInitializerMultipleAnnotations<T>
{
    private static final Logger logger = LoggerFactory.getLogger(IllegalInitializerMultipleAnnotations.class);

    @InitializerConfig
    public TestPayload execute(@Input @Object T data, UIDGenerator generator)
    {
        logger.info("input-object: {}", data);
        return new TestPayload(new TestObject(generator.generate(), "multiple_annotations"));
    }
}
