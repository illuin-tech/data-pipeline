...
public class ErrorHandlerTest
{
    ...
    {
        Pipeline<Void, A> pipeline = Assertions.assertDoesNotThrow(ErrorHandlerTest::createErrorThrownPipeline);
    ...
    {
        Pipeline<Void, A> pipeline = Assertions.assertDoesNotThrow(ErrorHandlerTest::createErrorHandledPipeline);
